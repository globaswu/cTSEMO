classdef SolverIntegrationTest < matlab.unittest.TestCase
    ...
    methods (Test, TestTags = {'Integration'})
        ...
        function testFeasibleRunScoresBothCompletePools(testCase)
            [primaryCount, challengerCount] = ...
                SolverIntegrationTest.completePoolCounts();

            testCase.verifyEqual(primaryCount, 48);
    ...
    methods (Static, Access = private)
        ...
        function [primaryCount, challengerCount] = ...
                completePoolCounts()
            result = SolverIntegrationTest.tinyCossinRun();
            record = result.iterations(1);
