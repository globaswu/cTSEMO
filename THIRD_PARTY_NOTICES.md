...
- `src/vendor/bradford-tsemo/TSEMO_V4.m`
- `src/vendor/bradford-tsemo/TSEMO_options.m`
- `src/vendor/bradford-tsemo/README.md`
- `src/vendor/bradford-tsemo/LICENSE`
...
- Yi Cao: `src/vendor/bradford-tsemo/TSEMO_V4.m`, lines 575--611;
- Carl Edward Rasmussen and Hannes Nickisch:
  `src/vendor/bradford-tsemo/TSEMO_V4.m`, lines 658--681 and 755--778; and
- Mo Chen: `src/vendor/bradford-tsemo/TSEMO_V4.m`, lines 718--748.
...
`src/benchmarks/provenance/benchmark-definitions.md`; no third-party benchmark
...
`src/benchmarks/getBenchmarkProblem.m` were checked against BoTorch at commit
...
retained at `src/benchmarks/provenance/botorch-LICENSE`. The upstream Python
...
`src/benchmarks/provenance/high-dimensional-benchmarks.md`.
